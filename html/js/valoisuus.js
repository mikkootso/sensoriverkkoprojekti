    ...
    $.ajax({
      ...
      success : function(data){
        ...
        function drawCards(rajat){
          const cards = [
            {id: 1, title: "Valoisuus", min: parseInt(rajat["ldr"].min), max: parseInt(rajat["ldr"].max), lastValues: {val: data[2][data[2].length-1].ldr, stamp: data[2][data[2].length-1].timeStamp, unit: "lx"}}
          ];
