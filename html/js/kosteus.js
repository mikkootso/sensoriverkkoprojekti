    ...
    $.ajax({
      ...
      success : function(data){
        ...
        function drawCards(rajat){
          const cards = [
            {id: 1, title: "Ilman kosteus", min: parseInt(rajat["hum1"].min), max: parseInt(rajat["hum1"].max), lastValues: {val: data[2][data[2].length-1].hum1, stamp: data[2][data[2].length-1].timeStamp, unit: "%"}}
          ];
