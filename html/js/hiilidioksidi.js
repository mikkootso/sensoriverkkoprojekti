    ...
    $.ajax({
      ...
      success : function(data){
        ...
        function drawCards(rajat){
          const cards = [
            {id: 1, title: "Hiilidioksidipitoisuus", min: parseInt(rajat["co2"].min), max: parseInt(rajat["co2"].max), lastValues: {val: data[2][data[2].length-1].co2, stamp: data[2][data[2].length-1].timeStamp, unit: "ppm"}}
          ];
